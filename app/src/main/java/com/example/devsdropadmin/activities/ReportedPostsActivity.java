...
import com.example.devsdropadmin.databinding.ActivityReportedPostsBinding;
...
public class ReportedPostsActivity extends AppCompatActivity {
    ActivityReportedPostsBinding binding;
    ...
    void setUpRecyclerView() {
        ...
        database.getReference()
                .child("reported_posts").addValueEventListener(new ValueEventListener() {
                    @Override
